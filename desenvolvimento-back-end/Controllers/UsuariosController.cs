...
namespace desenvolvimento_back_end.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        {
            var userInfo = await _context.Usuarios.FindAsync(usuario.Id);
            ...
            var senhaOk = BCrypt.Net.BCrypt.Verify(usuario.Senha, userInfo.Senha);

            if (senhaOk)
            {
                var claims = new List<Claim>
                {
                    new Claim(ClaimTypes.Name, userInfo.Nome),
                    new Claim(ClaimTypes.NameIdentifier, userInfo.Id.ToString()),
                    new Claim(ClaimTypes.Role, userInfo.Perfil.ToString()),
