...
namespace desenvolvimento_back_end.Controllers
{
    public class ConsumosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Data,Valor,Quilometragem,Tipo,VeiculoId")] Consumo consumo)
        {
            ...
            ViewData["VeiculoId"] = new SelectList(_context.Veiculos, "Id", "AnoModelo", consumo.VeiculoId);
            return View(consumo);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Data,Valor,Quilometragem,Tipo,VeiculoId")] Consumo consumo)
        {
            if (id != consumo.Id)
            {
                return NotFound();
